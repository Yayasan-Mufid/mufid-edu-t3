...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutUploaded_filesInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutUploaded_filesInputObjectSchema = Schema;
