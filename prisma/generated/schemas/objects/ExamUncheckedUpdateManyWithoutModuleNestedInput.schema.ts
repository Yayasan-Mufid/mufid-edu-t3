...
const Schema: z.ZodType<Prisma.ExamUncheckedUpdateManyWithoutModuleNestedInput> =
  z
    .object({
      create: z
        .union([
          ...
          z
            .lazy(() => ExamUncheckedCreateWithoutModuleInputObjectSchema)
            .array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          ...
          z
            .lazy(() => ExamCreateOrConnectWithoutModuleInputObjectSchema)
            .array(),
        ])
        .optional(),
      upsert: z
...
export const ExamUncheckedUpdateManyWithoutModuleNestedInputObjectSchema =
  Schema;
