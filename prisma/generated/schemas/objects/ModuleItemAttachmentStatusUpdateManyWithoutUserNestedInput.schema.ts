...
const Schema: z.ZodType<Prisma.ModuleItemAttachmentStatusUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleItemAttachmentStatusUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
