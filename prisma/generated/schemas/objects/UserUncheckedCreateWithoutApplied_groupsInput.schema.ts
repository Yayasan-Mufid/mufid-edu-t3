...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutApplied_groupsInput> =
  z
    .object({
...
export const UserUncheckedCreateWithoutApplied_groupsInputObjectSchema = Schema;
