...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutCreated_announcementsInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutCreated_announcementsInputObjectSchema =
  Schema;
