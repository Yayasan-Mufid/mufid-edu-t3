...
const Schema: z.ZodType<Prisma.StudyGroupUncheckedUpdateManyWithoutInvoice_accountNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const StudyGroupUncheckedUpdateManyWithoutInvoice_accountNestedInputObjectSchema =
  Schema;
