...
const Schema: z.ZodType<Prisma.StudyGroupUpdateWithoutInvoice_accountInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const StudyGroupUpdateWithoutInvoice_accountInputObjectSchema = Schema;
