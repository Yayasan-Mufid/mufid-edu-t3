...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutModule_item_statusInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutModule_item_statusInputObjectSchema =
  Schema;
