...
const Schema: z.ZodType<Prisma.StudyGroupUncheckedCreateWithoutStudentsInput> =
  z
    .object({
...
export const StudyGroupUncheckedCreateWithoutStudentsInputObjectSchema = Schema;
