...
const Schema: z.ZodType<Prisma.ModuleItemUncheckedCreateNestedManyWithoutModuleInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleItemUncheckedCreateNestedManyWithoutModuleInputObjectSchema =
  Schema;
