...
const Schema: z.ZodType<Prisma.ModuleAccessUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleAccessUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
