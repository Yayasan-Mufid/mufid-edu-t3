...
const Schema: z.ZodType<Prisma.ModuleItemCreateOrConnectWithoutScheduleInput> =
  z
    .object({
...
export const ModuleItemCreateOrConnectWithoutScheduleInputObjectSchema = Schema;
