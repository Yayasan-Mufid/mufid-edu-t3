...
const Schema: z.ZodType<Prisma.AnnouncementUncheckedCreateNestedManyWithoutCreated_byInput> =
  z
    .object({
      create: z
        .union([
...
export const AnnouncementUncheckedCreateNestedManyWithoutCreated_byInputObjectSchema =
  Schema;
