...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutUploaded_filesInput> =
  z
    .object({
...
export const UserUncheckedCreateWithoutUploaded_filesInputObjectSchema = Schema;
