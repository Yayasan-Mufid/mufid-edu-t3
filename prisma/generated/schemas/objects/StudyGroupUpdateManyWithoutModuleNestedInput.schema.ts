...
const Schema: z.ZodType<Prisma.StudyGroupUpdateManyWithoutModuleNestedInput> = z
  .object({
    create: z
      .union([
...
export const StudyGroupUpdateManyWithoutModuleNestedInputObjectSchema = Schema;
