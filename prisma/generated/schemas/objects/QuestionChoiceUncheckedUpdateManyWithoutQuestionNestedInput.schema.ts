...
const Schema: z.ZodType<Prisma.QuestionChoiceUncheckedUpdateManyWithoutQuestionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const QuestionChoiceUncheckedUpdateManyWithoutQuestionNestedInputObjectSchema =
  Schema;
