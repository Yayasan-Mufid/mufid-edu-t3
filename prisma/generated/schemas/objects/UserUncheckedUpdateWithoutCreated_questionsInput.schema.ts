...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutCreated_questionsInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutCreated_questionsInputObjectSchema =
  Schema;
