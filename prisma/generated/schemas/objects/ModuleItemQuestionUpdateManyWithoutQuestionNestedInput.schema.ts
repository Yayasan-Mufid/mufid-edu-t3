...
const Schema: z.ZodType<Prisma.ModuleItemQuestionUpdateManyWithoutQuestionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleItemQuestionUpdateManyWithoutQuestionNestedInputObjectSchema =
  Schema;
