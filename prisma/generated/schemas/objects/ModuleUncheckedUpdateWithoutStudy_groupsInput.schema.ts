...
const Schema: z.ZodType<Prisma.ModuleUncheckedUpdateWithoutStudy_groupsInput> =
  z
    .object({
      id: z
        .union([
...
export const ModuleUncheckedUpdateWithoutStudy_groupsInputObjectSchema = Schema;
