...
const Schema: z.ZodType<Prisma.ModuleItemUncheckedCreateWithoutScheduleInput> =
  z
    .object({
...
export const ModuleItemUncheckedCreateWithoutScheduleInputObjectSchema = Schema;
