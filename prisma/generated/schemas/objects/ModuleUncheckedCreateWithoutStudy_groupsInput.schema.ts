...
const Schema: z.ZodType<Prisma.ModuleUncheckedCreateWithoutStudy_groupsInput> =
  z
    .object({
...
export const ModuleUncheckedCreateWithoutStudy_groupsInputObjectSchema = Schema;
