...
const Schema: z.ZodType<Prisma.ModuleItemQuestionCreateNestedManyWithoutQuestionInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleItemQuestionCreateNestedManyWithoutQuestionInputObjectSchema =
  Schema;
