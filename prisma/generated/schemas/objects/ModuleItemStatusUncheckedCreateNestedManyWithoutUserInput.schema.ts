...
const Schema: z.ZodType<Prisma.ModuleItemStatusUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleItemStatusUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
