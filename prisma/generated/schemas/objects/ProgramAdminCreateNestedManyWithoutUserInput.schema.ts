...
const Schema: z.ZodType<Prisma.ProgramAdminCreateNestedManyWithoutUserInput> = z
  .object({
    create: z
      .union([
...
export const ProgramAdminCreateNestedManyWithoutUserInputObjectSchema = Schema;
