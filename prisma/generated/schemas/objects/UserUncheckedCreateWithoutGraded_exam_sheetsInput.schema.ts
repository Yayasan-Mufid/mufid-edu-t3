...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutGraded_exam_sheetsInput> =
  z
    .object({
...
export const UserUncheckedCreateWithoutGraded_exam_sheetsInputObjectSchema =
  Schema;
