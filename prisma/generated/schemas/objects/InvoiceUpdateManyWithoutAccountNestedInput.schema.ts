...
const Schema: z.ZodType<Prisma.InvoiceUpdateManyWithoutAccountNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => InvoiceUpdateManyWithWhereWithoutAccountInputObjectSchema),
        z
          .lazy(() => InvoiceUpdateManyWithWhereWithoutAccountInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const InvoiceUpdateManyWithoutAccountNestedInputObjectSchema = Schema;
