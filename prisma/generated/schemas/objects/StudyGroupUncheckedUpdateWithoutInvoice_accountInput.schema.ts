...
import { StudyGroupStudentUncheckedUpdateManyWithoutStudy_groupNestedInputObjectSchema } from './StudyGroupStudentUncheckedUpdateManyWithoutStudy_groupNestedInput.schema';
...
const Schema: z.ZodType<Prisma.StudyGroupUncheckedUpdateWithoutInvoice_accountInput> =
  z
    .object({
      id: z
        .union([
      ...
      students: z
        .lazy(
          () =>
            StudyGroupStudentUncheckedUpdateManyWithoutStudy_groupNestedInputObjectSchema,
        )
        .optional(),
      exams: z
        .lazy(
...
export const StudyGroupUncheckedUpdateWithoutInvoice_accountInputObjectSchema =
  Schema;
