...
const Schema: z.ZodType<Prisma.InvoiceUncheckedCreateNestedManyWithoutConfirmed_byInput> =
  z
    .object({
      create: z
        .union([
...
export const InvoiceUncheckedCreateNestedManyWithoutConfirmed_byInputObjectSchema =
  Schema;
