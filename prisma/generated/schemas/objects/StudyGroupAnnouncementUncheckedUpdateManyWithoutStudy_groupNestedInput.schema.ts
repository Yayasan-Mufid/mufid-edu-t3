...
const Schema: z.ZodType<Prisma.StudyGroupAnnouncementUncheckedUpdateManyWithoutStudy_groupNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const StudyGroupAnnouncementUncheckedUpdateManyWithoutStudy_groupNestedInputObjectSchema =
  Schema;
