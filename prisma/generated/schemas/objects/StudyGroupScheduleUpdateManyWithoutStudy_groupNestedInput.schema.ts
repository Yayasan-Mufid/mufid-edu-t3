...
const Schema: z.ZodType<Prisma.StudyGroupScheduleUpdateManyWithoutStudy_groupNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const StudyGroupScheduleUpdateManyWithoutStudy_groupNestedInputObjectSchema =
  Schema;
