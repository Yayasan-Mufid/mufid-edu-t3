...
const Schema: z.ZodType<Prisma.UserCreateWithoutModule_item_question_statusInput> =
  z
    .object({
...
export const UserCreateWithoutModule_item_question_statusInputObjectSchema =
  Schema;
