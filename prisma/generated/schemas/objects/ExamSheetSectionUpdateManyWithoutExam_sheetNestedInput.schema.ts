...
const Schema: z.ZodType<Prisma.ExamSheetSectionUpdateManyWithoutExam_sheetNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ExamSheetSectionUpdateManyWithoutExam_sheetNestedInputObjectSchema =
  Schema;
