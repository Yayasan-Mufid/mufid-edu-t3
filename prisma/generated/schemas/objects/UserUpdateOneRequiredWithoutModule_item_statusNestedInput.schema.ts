...
import { UserUpsertWithoutModule_item_statusInputObjectSchema } from './UserUpsertWithoutModule_item_statusInput.schema';
...
const Schema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutModule_item_statusNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      connectOrCreate: z
        ...
        .optional(),
      upsert: z
        .lazy(() => UserUpsertWithoutModule_item_statusInputObjectSchema)
        .optional(),
...
export const UserUpdateOneRequiredWithoutModule_item_statusNestedInputObjectSchema =
  Schema;
