...
const Schema: z.ZodType<Prisma.QuestionUpdateManyWithWhereWithoutModuleInput> =
  z
    .object({
...
export const QuestionUpdateManyWithWhereWithoutModuleInputObjectSchema = Schema;
