...
const Schema: z.ZodType<Prisma.ModuleItemAttachmentStatusUncheckedUpdateManyWithoutAttachmentNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleItemAttachmentStatusUncheckedUpdateManyWithoutAttachmentNestedInputObjectSchema =
  Schema;
