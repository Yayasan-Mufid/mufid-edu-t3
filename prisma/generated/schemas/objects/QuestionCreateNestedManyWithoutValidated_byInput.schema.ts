...
const Schema: z.ZodType<Prisma.QuestionCreateNestedManyWithoutValidated_byInput> =
  z
    .object({
      create: z
        .union([
...
export const QuestionCreateNestedManyWithoutValidated_byInputObjectSchema =
  Schema;
