...
const Schema: z.ZodType<Prisma.ModuleItemUncheckedUpdateManyWithoutParent_itemNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleItemUncheckedUpdateManyWithoutParent_itemNestedInputObjectSchema =
  Schema;
