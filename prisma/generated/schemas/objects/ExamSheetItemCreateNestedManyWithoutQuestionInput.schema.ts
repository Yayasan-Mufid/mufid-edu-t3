...
const Schema: z.ZodType<Prisma.ExamSheetItemCreateNestedManyWithoutQuestionInput> =
  z
    .object({
      create: z
        .union([
...
export const ExamSheetItemCreateNestedManyWithoutQuestionInputObjectSchema =
  Schema;
