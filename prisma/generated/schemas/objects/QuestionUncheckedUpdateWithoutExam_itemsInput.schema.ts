...
const Schema: z.ZodType<Prisma.QuestionUncheckedUpdateWithoutExam_itemsInput> =
  z
    .object({
      id: z
        .union([
...
export const QuestionUncheckedUpdateWithoutExam_itemsInputObjectSchema = Schema;
