...
const Schema: z.ZodType<Prisma.ExamSheetUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => ExamSheetUpdateManyWithWhereWithoutUserInputObjectSchema,
          ),
          z
            .lazy(
              () => ExamSheetUpdateManyWithWhereWithoutUserInputObjectSchema,
...
export const ExamSheetUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
