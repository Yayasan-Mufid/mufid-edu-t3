...
const Schema: z.ZodType<Prisma.ExamSectionQuestionUncheckedUpdateManyWithoutQuestionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ExamSectionQuestionUncheckedUpdateManyWithoutQuestionNestedInputObjectSchema =
  Schema;
