...
import { QuestionUncheckedUpdateManyWithoutValidated_byNestedInputObjectSchema } from './QuestionUncheckedUpdateManyWithoutValidated_byNestedInput.schema';
...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutExam_sheetsInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    sessions: z
      ...
      .optional(),
    roles: z
      .lazy(() => UserRoleUncheckedUpdateManyWithoutUserNestedInputObjectSchema)
      .optional(),
    invoices: z
    ...
    validated_questions: z
      .lazy(
        () =>
          QuestionUncheckedUpdateManyWithoutValidated_byNestedInputObjectSchema,
      )
      .optional(),
...
export const UserUncheckedUpdateWithoutExam_sheetsInputObjectSchema = Schema;
