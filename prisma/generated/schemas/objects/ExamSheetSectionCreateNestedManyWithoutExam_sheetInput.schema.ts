...
const Schema: z.ZodType<Prisma.ExamSheetSectionCreateNestedManyWithoutExam_sheetInput> =
  z
    .object({
      create: z
        .union([
...
export const ExamSheetSectionCreateNestedManyWithoutExam_sheetInputObjectSchema =
  Schema;
