...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutGraded_exam_sheetsInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutGraded_exam_sheetsInputObjectSchema =
  Schema;
