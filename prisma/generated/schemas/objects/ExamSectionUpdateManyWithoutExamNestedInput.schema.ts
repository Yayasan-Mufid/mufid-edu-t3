...
const Schema: z.ZodType<Prisma.ExamSectionUpdateManyWithoutExamNestedInput> = z
  .object({
    create: z
      .union([
...
export const ExamSectionUpdateManyWithoutExamNestedInputObjectSchema = Schema;
