...
const Schema: z.ZodType<Prisma.StudyGroupApplicantUncheckedCreateNestedOneWithoutInvoiceInput> =
  z
    .object({
      create: z
        .union([
...
export const StudyGroupApplicantUncheckedCreateNestedOneWithoutInvoiceInputObjectSchema =
  Schema;
