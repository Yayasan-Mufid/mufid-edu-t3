...
const Schema: z.ZodType<Prisma.ModuleItemUncheckedCreateWithoutUser_statusInput> =
  z
    .object({
...
export const ModuleItemUncheckedCreateWithoutUser_statusInputObjectSchema =
  Schema;
