...
const Schema: z.ZodType<Prisma.ExamSectionCreateNestedManyWithoutExamInput> = z
  .object({
    create: z
      .union([
...
export const ExamSectionCreateNestedManyWithoutExamInputObjectSchema = Schema;
