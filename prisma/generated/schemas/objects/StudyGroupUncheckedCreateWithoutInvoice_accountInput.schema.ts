...
const Schema: z.ZodType<Prisma.StudyGroupUncheckedCreateWithoutInvoice_accountInput> =
  z
    .object({
...
export const StudyGroupUncheckedCreateWithoutInvoice_accountInputObjectSchema =
  Schema;
