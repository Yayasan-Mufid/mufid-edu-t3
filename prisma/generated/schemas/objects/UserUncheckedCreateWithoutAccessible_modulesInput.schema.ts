...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutAccessible_modulesInput> =
  z
    .object({
...
export const UserUncheckedCreateWithoutAccessible_modulesInputObjectSchema =
  Schema;
