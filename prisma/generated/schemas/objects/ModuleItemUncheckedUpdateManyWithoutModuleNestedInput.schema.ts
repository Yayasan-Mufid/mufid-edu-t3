...
const Schema: z.ZodType<Prisma.ModuleItemUncheckedUpdateManyWithoutModuleNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleItemUncheckedUpdateManyWithoutModuleNestedInputObjectSchema =
  Schema;
