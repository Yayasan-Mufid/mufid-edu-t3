...
const Schema: z.ZodType<Prisma.UserRoleUncheckedCreateNestedManyWithoutRoleInput> =
  z
    .object({
      create: z
        .union([
...
export const UserRoleUncheckedCreateNestedManyWithoutRoleInputObjectSchema =
  Schema;
