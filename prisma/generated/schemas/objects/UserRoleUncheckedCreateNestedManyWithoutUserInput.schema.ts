...
const Schema: z.ZodType<Prisma.UserRoleUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const UserRoleUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
