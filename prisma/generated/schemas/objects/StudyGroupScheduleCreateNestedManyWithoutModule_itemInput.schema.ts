...
const Schema: z.ZodType<Prisma.StudyGroupScheduleCreateNestedManyWithoutModule_itemInput> =
  z
    .object({
      create: z
        .union([
...
export const StudyGroupScheduleCreateNestedManyWithoutModule_itemInputObjectSchema =
  Schema;
