...
const Schema: z.ZodType<Prisma.StudyGroupUncheckedUpdateWithoutModuleInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const StudyGroupUncheckedUpdateWithoutModuleInputObjectSchema = Schema;
