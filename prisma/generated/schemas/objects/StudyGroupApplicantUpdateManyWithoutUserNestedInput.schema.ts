...
const Schema: z.ZodType<Prisma.StudyGroupApplicantUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const StudyGroupApplicantUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
