...
const Schema: z.ZodType<Prisma.QuestionUncheckedUpdateManyWithoutModuleNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => QuestionUpdateManyWithWhereWithoutModuleInputObjectSchema,
          ),
          z
            .lazy(
              () => QuestionUpdateManyWithWhereWithoutModuleInputObjectSchema,
...
export const QuestionUncheckedUpdateManyWithoutModuleNestedInputObjectSchema =
  Schema;
