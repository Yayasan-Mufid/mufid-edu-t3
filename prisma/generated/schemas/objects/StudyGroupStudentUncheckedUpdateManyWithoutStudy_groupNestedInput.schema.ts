...
const Schema: z.ZodType<Prisma.StudyGroupStudentUncheckedUpdateManyWithoutStudy_groupNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const StudyGroupStudentUncheckedUpdateManyWithoutStudy_groupNestedInputObjectSchema =
  Schema;
