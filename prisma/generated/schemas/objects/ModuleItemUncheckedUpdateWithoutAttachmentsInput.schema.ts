...
const Schema: z.ZodType<Prisma.ModuleItemUncheckedUpdateWithoutAttachmentsInput> =
  z
    .object({
      id: z
        .union([
...
export const ModuleItemUncheckedUpdateWithoutAttachmentsInputObjectSchema =
  Schema;
