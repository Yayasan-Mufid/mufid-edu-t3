...
import { ModuleUpdateOneWithoutQuestionsNestedInputObjectSchema } from './ModuleUpdateOneWithoutQuestionsNestedInput.schema';
...
const Schema: z.ZodType<Prisma.QuestionUpdateWithoutModule_item_questionInput> =
  z
    .object({
      id: z
        .union([
      ...
      program: z
        ...
        .optional(),
      module: z
        .lazy(() => ModuleUpdateOneWithoutQuestionsNestedInputObjectSchema)
        .optional(),
      text: z
        .union([
          z.string(),
      ...
      exam_items: z
        .lazy(
          () => ExamSheetItemUpdateManyWithoutQuestionNestedInputObjectSchema,
        )
        .optional(),
    })
    .strict();

export const QuestionUpdateWithoutModule_item_questionInputObjectSchema =
  Schema;
