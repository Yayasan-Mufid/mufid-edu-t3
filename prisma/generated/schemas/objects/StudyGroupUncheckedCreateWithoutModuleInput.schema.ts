...
const Schema: z.ZodType<Prisma.StudyGroupUncheckedCreateWithoutModuleInput> = z
  .object({
...
export const StudyGroupUncheckedCreateWithoutModuleInputObjectSchema = Schema;
