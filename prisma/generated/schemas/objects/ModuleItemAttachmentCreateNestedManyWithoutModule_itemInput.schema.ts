...
const Schema: z.ZodType<Prisma.ModuleItemAttachmentCreateNestedManyWithoutModule_itemInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleItemAttachmentCreateNestedManyWithoutModule_itemInputObjectSchema =
  Schema;
