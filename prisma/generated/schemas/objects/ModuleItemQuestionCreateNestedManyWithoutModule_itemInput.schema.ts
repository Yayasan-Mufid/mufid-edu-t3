...
const Schema: z.ZodType<Prisma.ModuleItemQuestionCreateNestedManyWithoutModule_itemInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleItemQuestionCreateNestedManyWithoutModule_itemInputObjectSchema =
  Schema;
