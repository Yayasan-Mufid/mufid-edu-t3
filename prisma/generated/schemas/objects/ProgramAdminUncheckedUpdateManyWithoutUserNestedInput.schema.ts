...
const Schema: z.ZodType<Prisma.ProgramAdminUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProgramAdminUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
