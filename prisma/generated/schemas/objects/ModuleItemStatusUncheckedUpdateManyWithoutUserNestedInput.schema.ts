...
const Schema: z.ZodType<Prisma.ModuleItemStatusUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleItemStatusUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
