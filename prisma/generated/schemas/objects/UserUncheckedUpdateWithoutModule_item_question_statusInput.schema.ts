...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutModule_item_question_statusInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutModule_item_question_statusInputObjectSchema =
  Schema;
