...
const Schema: z.ZodType<Prisma.RolePermissionUncheckedCreateNestedManyWithoutRoleInput> =
  z
    .object({
      create: z
        .union([
...
export const RolePermissionUncheckedCreateNestedManyWithoutRoleInputObjectSchema =
  Schema;
