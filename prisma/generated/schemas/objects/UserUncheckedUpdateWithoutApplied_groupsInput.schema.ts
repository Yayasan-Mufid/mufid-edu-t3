...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutApplied_groupsInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutApplied_groupsInputObjectSchema = Schema;
