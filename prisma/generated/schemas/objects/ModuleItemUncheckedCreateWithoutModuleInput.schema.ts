...
const Schema: z.ZodType<Prisma.ModuleItemUncheckedCreateWithoutModuleInput> = z
  .object({
...
export const ModuleItemUncheckedCreateWithoutModuleInputObjectSchema = Schema;
