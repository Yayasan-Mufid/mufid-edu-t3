...
const Schema: z.ZodType<Prisma.ExamSectionUpdateWithoutSheet_sectionsInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const ExamSectionUpdateWithoutSheet_sectionsInputObjectSchema = Schema;
