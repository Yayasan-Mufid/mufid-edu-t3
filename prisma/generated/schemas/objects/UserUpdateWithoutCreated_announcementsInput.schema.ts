...
import { ModuleItemAttachmentStatusUpdateManyWithoutUserNestedInputObjectSchema } from './ModuleItemAttachmentStatusUpdateManyWithoutUserNestedInput.schema';
...
const Schema: z.ZodType<Prisma.UserUpdateWithoutCreated_announcementsInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    module_item_status: z
      .lazy(() => ModuleItemStatusUpdateManyWithoutUserNestedInputObjectSchema)
      .optional(),
    module_item_attachment_status: z
      .lazy(
        () =>
          ModuleItemAttachmentStatusUpdateManyWithoutUserNestedInputObjectSchema,
      )
      .optional(),
    applied_groups: z
      .lazy(
      ...
      .optional(),
    enrolled_groups: z
      .lazy(() => StudyGroupStudentUpdateManyWithoutUserNestedInputObjectSchema)
      .optional(),
    managed_groups: z
    ...
    validated_questions: z
      .lazy(() => QuestionUpdateManyWithoutValidated_byNestedInputObjectSchema)
      .optional(),
    exam_sheets: z
    ...
    graded_exam_item: z
      ...
      .optional(),
    uploaded_files: z
      .lazy(() => UploadedFileUpdateManyWithoutUploaderNestedInputObjectSchema)
      .optional(),
...
export const UserUpdateWithoutCreated_announcementsInputObjectSchema = Schema;
