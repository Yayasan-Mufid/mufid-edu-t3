...
const Schema: z.ZodType<Prisma.ModuleItemAttachmentStatusCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleItemAttachmentStatusCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
