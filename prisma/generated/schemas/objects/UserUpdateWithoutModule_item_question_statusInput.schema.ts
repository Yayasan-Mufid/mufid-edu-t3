...
const Schema: z.ZodType<Prisma.UserUpdateWithoutModule_item_question_statusInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUpdateWithoutModule_item_question_statusInputObjectSchema =
  Schema;
