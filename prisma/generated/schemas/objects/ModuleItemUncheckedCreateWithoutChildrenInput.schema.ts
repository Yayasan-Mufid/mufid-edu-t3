...
const Schema: z.ZodType<Prisma.ModuleItemUncheckedCreateWithoutChildrenInput> =
  z
    .object({
...
export const ModuleItemUncheckedCreateWithoutChildrenInputObjectSchema = Schema;
