...
import { StudyGroupApplicantOrderByWithRelationInputObjectSchema } from './StudyGroupApplicantOrderByWithRelationInput.schema';
...
const Schema: z.ZodType<Prisma.InvoiceOrderByWithRelationInput> = z
  .object({
    ...
    items: z
      ...
      .optional(),
    applicant: z
      .lazy(() => StudyGroupApplicantOrderByWithRelationInputObjectSchema)
      .optional(),
  })
  .strict();
