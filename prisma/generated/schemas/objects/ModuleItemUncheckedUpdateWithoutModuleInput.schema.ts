...
const Schema: z.ZodType<Prisma.ModuleItemUncheckedUpdateWithoutModuleInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const ModuleItemUncheckedUpdateWithoutModuleInputObjectSchema = Schema;
