...
const Schema: z.ZodType<Prisma.StudyGroupUncheckedCreateWithoutScheduleInput> =
  z
    .object({
...
export const StudyGroupUncheckedCreateWithoutScheduleInputObjectSchema = Schema;
