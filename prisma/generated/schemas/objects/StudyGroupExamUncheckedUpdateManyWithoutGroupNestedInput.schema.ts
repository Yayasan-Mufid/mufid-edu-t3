...
const Schema: z.ZodType<Prisma.StudyGroupExamUncheckedUpdateManyWithoutGroupNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const StudyGroupExamUncheckedUpdateManyWithoutGroupNestedInputObjectSchema =
  Schema;
