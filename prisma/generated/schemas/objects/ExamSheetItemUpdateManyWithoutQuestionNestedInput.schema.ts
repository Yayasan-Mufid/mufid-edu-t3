...
const Schema: z.ZodType<Prisma.ExamSheetItemUpdateManyWithoutQuestionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ExamSheetItemUpdateManyWithoutQuestionNestedInputObjectSchema =
  Schema;
