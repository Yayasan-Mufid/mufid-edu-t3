...
const Schema: z.ZodType<Prisma.ExamSheetItemUncheckedCreateNestedManyWithoutGraded_byInput> =
  z
    .object({
      create: z
        .union([
...
export const ExamSheetItemUncheckedCreateNestedManyWithoutGraded_byInputObjectSchema =
  Schema;
