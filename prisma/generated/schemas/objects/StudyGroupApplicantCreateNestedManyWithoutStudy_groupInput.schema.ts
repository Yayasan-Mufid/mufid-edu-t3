...
const Schema: z.ZodType<Prisma.StudyGroupApplicantCreateNestedManyWithoutStudy_groupInput> =
  z
    .object({
      create: z
        .union([
...
export const StudyGroupApplicantCreateNestedManyWithoutStudy_groupInputObjectSchema =
  Schema;
