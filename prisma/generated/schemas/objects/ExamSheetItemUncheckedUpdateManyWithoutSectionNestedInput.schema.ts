...
const Schema: z.ZodType<Prisma.ExamSheetItemUncheckedUpdateManyWithoutSectionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ExamSheetItemUncheckedUpdateManyWithoutSectionNestedInputObjectSchema =
  Schema;
