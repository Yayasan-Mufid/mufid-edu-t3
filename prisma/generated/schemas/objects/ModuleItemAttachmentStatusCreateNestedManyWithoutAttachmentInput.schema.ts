...
const Schema: z.ZodType<Prisma.ModuleItemAttachmentStatusCreateNestedManyWithoutAttachmentInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleItemAttachmentStatusCreateNestedManyWithoutAttachmentInputObjectSchema =
  Schema;
