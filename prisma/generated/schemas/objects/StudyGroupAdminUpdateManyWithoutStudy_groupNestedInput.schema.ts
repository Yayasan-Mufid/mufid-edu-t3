...
const Schema: z.ZodType<Prisma.StudyGroupAdminUpdateManyWithoutStudy_groupNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const StudyGroupAdminUpdateManyWithoutStudy_groupNestedInputObjectSchema =
  Schema;
