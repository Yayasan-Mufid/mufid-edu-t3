...
const Schema: z.ZodType<Prisma.ExamSectionQuestionUncheckedCreateNestedManyWithoutQuestionInput> =
  z
    .object({
      create: z
        .union([
...
export const ExamSectionQuestionUncheckedCreateNestedManyWithoutQuestionInputObjectSchema =
  Schema;
