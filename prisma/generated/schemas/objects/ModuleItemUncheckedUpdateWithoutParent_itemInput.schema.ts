...
const Schema: z.ZodType<Prisma.ModuleItemUncheckedUpdateWithoutParent_itemInput> =
  z
    .object({
      id: z
        .union([
...
export const ModuleItemUncheckedUpdateWithoutParent_itemInputObjectSchema =
  Schema;
