...
const Schema: z.ZodType<Prisma.UserCreateWithoutModule_item_attachment_statusInput> =
  z
    .object({
      ...
      module_item_status: z
        .lazy(
          () => ModuleItemStatusCreateNestedManyWithoutUserInputObjectSchema,
        )
        .optional(),
      applied_groups: z
        .lazy(
      ...
      enrolled_groups: z
        .lazy(
          () => StudyGroupStudentCreateNestedManyWithoutUserInputObjectSchema,
        )
        .optional(),
      managed_groups: z
      ...
      validated_questions: z
        .lazy(
          () => QuestionCreateNestedManyWithoutValidated_byInputObjectSchema,
        )
        .optional(),
      exam_sheets: z
      ...
      uploaded_files: z
        .lazy(
          () => UploadedFileCreateNestedManyWithoutUploaderInputObjectSchema,
        )
        .optional(),
...
export const UserCreateWithoutModule_item_attachment_statusInputObjectSchema =
  Schema;
