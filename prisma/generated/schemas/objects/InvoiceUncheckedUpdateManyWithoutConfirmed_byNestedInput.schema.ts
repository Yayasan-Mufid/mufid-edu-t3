...
const Schema: z.ZodType<Prisma.InvoiceUncheckedUpdateManyWithoutConfirmed_byNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const InvoiceUncheckedUpdateManyWithoutConfirmed_byNestedInputObjectSchema =
  Schema;
