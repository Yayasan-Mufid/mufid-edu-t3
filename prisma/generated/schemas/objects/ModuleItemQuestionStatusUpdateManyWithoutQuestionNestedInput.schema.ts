...
const Schema: z.ZodType<Prisma.ModuleItemQuestionStatusUpdateManyWithoutQuestionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleItemQuestionStatusUpdateManyWithoutQuestionNestedInputObjectSchema =
  Schema;
