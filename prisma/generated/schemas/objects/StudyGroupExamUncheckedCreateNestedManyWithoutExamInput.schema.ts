...
const Schema: z.ZodType<Prisma.StudyGroupExamUncheckedCreateNestedManyWithoutExamInput> =
  z
    .object({
      create: z
        .union([
...
export const StudyGroupExamUncheckedCreateNestedManyWithoutExamInputObjectSchema =
  Schema;
