...
const Schema: z.ZodType<Prisma.ExamSectionQuestionUncheckedUpdateManyWithoutSectionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ExamSectionQuestionUncheckedUpdateManyWithoutSectionNestedInputObjectSchema =
  Schema;
