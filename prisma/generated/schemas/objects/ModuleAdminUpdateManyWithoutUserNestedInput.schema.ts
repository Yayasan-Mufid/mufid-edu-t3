...
const Schema: z.ZodType<Prisma.ModuleAdminUpdateManyWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
...
export const ModuleAdminUpdateManyWithoutUserNestedInputObjectSchema = Schema;
