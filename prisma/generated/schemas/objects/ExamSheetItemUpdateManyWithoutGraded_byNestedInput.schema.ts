...
const Schema: z.ZodType<Prisma.ExamSheetItemUpdateManyWithoutGraded_byNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ExamSheetItemUpdateManyWithoutGraded_byNestedInputObjectSchema =
  Schema;
