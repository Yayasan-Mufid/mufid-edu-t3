...
const Schema: z.ZodType<Prisma.ExamSectionQuestionCountOrderByAggregateInput> =
  z
    .object({
...
export const ExamSectionQuestionCountOrderByAggregateInputObjectSchema = Schema;
