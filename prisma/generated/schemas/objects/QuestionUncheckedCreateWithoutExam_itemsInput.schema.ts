...
const Schema: z.ZodType<Prisma.QuestionUncheckedCreateWithoutExam_itemsInput> =
  z
    .object({
...
export const QuestionUncheckedCreateWithoutExam_itemsInputObjectSchema = Schema;
