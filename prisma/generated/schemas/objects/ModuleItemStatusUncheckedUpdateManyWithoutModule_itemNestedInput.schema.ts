...
const Schema: z.ZodType<Prisma.ModuleItemStatusUncheckedUpdateManyWithoutModule_itemNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleItemStatusUncheckedUpdateManyWithoutModule_itemNestedInputObjectSchema =
  Schema;
