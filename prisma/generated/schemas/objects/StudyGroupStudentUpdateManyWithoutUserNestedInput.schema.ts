...
const Schema: z.ZodType<Prisma.StudyGroupStudentUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const StudyGroupStudentUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
