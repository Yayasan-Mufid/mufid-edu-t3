...
const Schema: z.ZodType<Prisma.StudyGroupUncheckedUpdateWithoutScheduleInput> =
  z
    .object({
      id: z
        .union([
...
export const StudyGroupUncheckedUpdateWithoutScheduleInputObjectSchema = Schema;
