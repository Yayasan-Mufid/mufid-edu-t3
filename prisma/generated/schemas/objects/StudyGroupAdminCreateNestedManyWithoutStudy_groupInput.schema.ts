...
const Schema: z.ZodType<Prisma.StudyGroupAdminCreateNestedManyWithoutStudy_groupInput> =
  z
    .object({
      create: z
        .union([
...
export const StudyGroupAdminCreateNestedManyWithoutStudy_groupInputObjectSchema =
  Schema;
