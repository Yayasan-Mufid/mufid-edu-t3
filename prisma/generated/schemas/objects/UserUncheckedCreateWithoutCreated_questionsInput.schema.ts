...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutCreated_questionsInput> =
  z
    .object({
...
export const UserUncheckedCreateWithoutCreated_questionsInputObjectSchema =
  Schema;
