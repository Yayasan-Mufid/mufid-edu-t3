...
const Schema: z.ZodType<Prisma.ModuleItemQuestionStatusUncheckedCreateNestedManyWithoutQuestionInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleItemQuestionStatusUncheckedCreateNestedManyWithoutQuestionInputObjectSchema =
  Schema;
