...
const Schema: z.ZodType<Prisma.QuestionUncheckedCreateWithoutCreated_byInput> =
  z
    .object({
...
export const QuestionUncheckedCreateWithoutCreated_byInputObjectSchema = Schema;
