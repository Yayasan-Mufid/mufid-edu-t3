...
const Schema: z.ZodType<Prisma.ModuleAdminCreateNestedManyWithoutUserInput> = z
  .object({
    create: z
      .union([
...
export const ModuleAdminCreateNestedManyWithoutUserInputObjectSchema = Schema;
