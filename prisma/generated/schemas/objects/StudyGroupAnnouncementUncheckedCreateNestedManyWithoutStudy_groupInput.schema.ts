...
const Schema: z.ZodType<Prisma.StudyGroupAnnouncementUncheckedCreateNestedManyWithoutStudy_groupInput> =
  z
    .object({
      create: z
        .union([
...
export const StudyGroupAnnouncementUncheckedCreateNestedManyWithoutStudy_groupInputObjectSchema =
  Schema;
