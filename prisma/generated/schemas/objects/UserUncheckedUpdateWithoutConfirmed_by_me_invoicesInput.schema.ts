...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutConfirmed_by_me_invoicesInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutConfirmed_by_me_invoicesInputObjectSchema =
  Schema;
