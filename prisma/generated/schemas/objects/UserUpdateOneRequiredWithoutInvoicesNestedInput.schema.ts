...
const Schema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutInvoicesNestedInput> =
  z
    .object({
      create: z
        .union([
        ...
        .optional(),
      connectOrCreate: z
        .lazy(() => UserCreateOrConnectWithoutInvoicesInputObjectSchema)
        .optional(),
      upsert: z
        .lazy(() => UserUpsertWithoutInvoicesInputObjectSchema)
        .optional(),
...
export const UserUpdateOneRequiredWithoutInvoicesNestedInputObjectSchema =
  Schema;
