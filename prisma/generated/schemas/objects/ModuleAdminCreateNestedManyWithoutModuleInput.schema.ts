...
const Schema: z.ZodType<Prisma.ModuleAdminCreateNestedManyWithoutModuleInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleAdminCreateNestedManyWithoutModuleInputObjectSchema = Schema;
