...
const Schema: z.ZodType<Prisma.StudyGroupUncheckedCreateWithoutAnnouncementsInput> =
  z
    .object({
...
export const StudyGroupUncheckedCreateWithoutAnnouncementsInputObjectSchema =
  Schema;
