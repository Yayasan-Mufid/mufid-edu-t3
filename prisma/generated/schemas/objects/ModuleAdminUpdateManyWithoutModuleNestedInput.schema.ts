...
const Schema: z.ZodType<Prisma.ModuleAdminUpdateManyWithoutModuleNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleAdminUpdateManyWithoutModuleNestedInputObjectSchema = Schema;
