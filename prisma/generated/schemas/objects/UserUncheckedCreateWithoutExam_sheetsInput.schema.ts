...
import { ExamSheetItemUncheckedCreateNestedManyWithoutGraded_byInputObjectSchema } from './ExamSheetItemUncheckedCreateNestedManyWithoutGraded_byInput.schema';
...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutExam_sheetsInput> = z
  .object({
    ...
    sessions: z
      ...
      .optional(),
    roles: z
      .lazy(() => UserRoleUncheckedCreateNestedManyWithoutUserInputObjectSchema)
      .optional(),
    invoices: z
    ...
    graded_exam_item: z
      .lazy(
        () =>
          ExamSheetItemUncheckedCreateNestedManyWithoutGraded_byInputObjectSchema,
      )
      .optional(),
...
export const UserUncheckedCreateWithoutExam_sheetsInputObjectSchema = Schema;
