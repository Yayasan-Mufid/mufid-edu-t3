...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutConfirmed_by_me_invoicesInput> =
  z
    .object({
...
export const UserUncheckedCreateWithoutConfirmed_by_me_invoicesInputObjectSchema =
  Schema;
