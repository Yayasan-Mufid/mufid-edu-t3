...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutValidated_questionsInput> =
  z
    .object({
...
export const UserUncheckedCreateWithoutValidated_questionsInputObjectSchema =
  Schema;
