...
const Schema: z.ZodType<Prisma.ModuleItemUncheckedCreateWithoutAttachmentsInput> =
  z
    .object({
...
export const ModuleItemUncheckedCreateWithoutAttachmentsInputObjectSchema =
  Schema;
