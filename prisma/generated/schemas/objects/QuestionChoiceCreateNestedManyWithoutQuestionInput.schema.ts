...
const Schema: z.ZodType<Prisma.QuestionChoiceCreateNestedManyWithoutQuestionInput> =
  z
    .object({
      create: z
        .union([
...
export const QuestionChoiceCreateNestedManyWithoutQuestionInputObjectSchema =
  Schema;
