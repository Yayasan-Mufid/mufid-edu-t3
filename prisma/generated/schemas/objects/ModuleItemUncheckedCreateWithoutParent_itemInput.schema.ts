...
const Schema: z.ZodType<Prisma.ModuleItemUncheckedCreateWithoutParent_itemInput> =
  z
    .object({
...
export const ModuleItemUncheckedCreateWithoutParent_itemInputObjectSchema =
  Schema;
