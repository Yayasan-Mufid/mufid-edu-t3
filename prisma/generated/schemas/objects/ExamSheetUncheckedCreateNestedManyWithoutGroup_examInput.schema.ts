...
const Schema: z.ZodType<Prisma.ExamSheetUncheckedCreateNestedManyWithoutGroup_examInput> =
  z
    .object({
      create: z
        .union([
...
export const ExamSheetUncheckedCreateNestedManyWithoutGroup_examInputObjectSchema =
  Schema;
