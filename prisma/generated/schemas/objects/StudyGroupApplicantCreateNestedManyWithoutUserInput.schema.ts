...
const Schema: z.ZodType<Prisma.StudyGroupApplicantCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const StudyGroupApplicantCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
