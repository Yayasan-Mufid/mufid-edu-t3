...
const Schema: z.ZodType<Prisma.StudyGroupExamUncheckedUpdateWithoutExamInput> =
  z
    .object({
      id: z
        .union([
...
export const StudyGroupExamUncheckedUpdateWithoutExamInputObjectSchema = Schema;
