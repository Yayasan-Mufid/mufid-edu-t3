...
const Schema: z.ZodType<Prisma.StudyGroupAnnouncementUpdateManyWithoutAnnouncementNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const StudyGroupAnnouncementUpdateManyWithoutAnnouncementNestedInputObjectSchema =
  Schema;
