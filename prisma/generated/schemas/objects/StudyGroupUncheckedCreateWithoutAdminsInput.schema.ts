...
const Schema: z.ZodType<Prisma.StudyGroupUncheckedCreateWithoutAdminsInput> = z
  .object({
...
export const StudyGroupUncheckedCreateWithoutAdminsInputObjectSchema = Schema;
