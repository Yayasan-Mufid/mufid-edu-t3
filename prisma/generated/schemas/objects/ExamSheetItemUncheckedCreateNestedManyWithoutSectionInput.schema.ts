...
const Schema: z.ZodType<Prisma.ExamSheetItemUncheckedCreateNestedManyWithoutSectionInput> =
  z
    .object({
      create: z
        .union([
...
export const ExamSheetItemUncheckedCreateNestedManyWithoutSectionInputObjectSchema =
  Schema;
