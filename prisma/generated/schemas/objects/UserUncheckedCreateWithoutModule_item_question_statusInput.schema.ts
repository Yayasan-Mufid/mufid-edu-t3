...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutModule_item_question_statusInput> =
  z
    .object({
...
export const UserUncheckedCreateWithoutModule_item_question_statusInputObjectSchema =
  Schema;
