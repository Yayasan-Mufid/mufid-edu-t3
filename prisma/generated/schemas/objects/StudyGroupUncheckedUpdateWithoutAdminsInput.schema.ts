...
const Schema: z.ZodType<Prisma.StudyGroupUncheckedUpdateWithoutAdminsInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const StudyGroupUncheckedUpdateWithoutAdminsInputObjectSchema = Schema;
