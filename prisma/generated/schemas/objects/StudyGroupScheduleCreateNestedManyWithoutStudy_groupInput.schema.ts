...
const Schema: z.ZodType<Prisma.StudyGroupScheduleCreateNestedManyWithoutStudy_groupInput> =
  z
    .object({
      create: z
        .union([
...
export const StudyGroupScheduleCreateNestedManyWithoutStudy_groupInputObjectSchema =
  Schema;
