...
const Schema: z.ZodType<Prisma.StudyGroupUncheckedUpdateWithoutAnnouncementsInput> =
  z
    .object({
      id: z
        .union([
...
export const StudyGroupUncheckedUpdateWithoutAnnouncementsInputObjectSchema =
  Schema;
