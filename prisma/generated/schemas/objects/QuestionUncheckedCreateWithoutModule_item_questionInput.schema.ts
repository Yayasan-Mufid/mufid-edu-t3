...
const Schema: z.ZodType<Prisma.QuestionUncheckedCreateWithoutModule_item_questionInput> =
  z
    .object({
...
export const QuestionUncheckedCreateWithoutModule_item_questionInputObjectSchema =
  Schema;
