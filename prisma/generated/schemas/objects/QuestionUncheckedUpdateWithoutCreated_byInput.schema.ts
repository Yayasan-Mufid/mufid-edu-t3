...
const Schema: z.ZodType<Prisma.QuestionUncheckedUpdateWithoutCreated_byInput> =
  z
    .object({
      id: z
        .union([
...
export const QuestionUncheckedUpdateWithoutCreated_byInputObjectSchema = Schema;
