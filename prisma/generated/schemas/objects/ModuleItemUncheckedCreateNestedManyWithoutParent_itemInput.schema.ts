...
const Schema: z.ZodType<Prisma.ModuleItemUncheckedCreateNestedManyWithoutParent_itemInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleItemUncheckedCreateNestedManyWithoutParent_itemInputObjectSchema =
  Schema;
