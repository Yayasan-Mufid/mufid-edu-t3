...
const Schema: z.ZodType<Prisma.StudyGroupApplicantUpdateOneWithoutInvoiceNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const StudyGroupApplicantUpdateOneWithoutInvoiceNestedInputObjectSchema =
  Schema;
