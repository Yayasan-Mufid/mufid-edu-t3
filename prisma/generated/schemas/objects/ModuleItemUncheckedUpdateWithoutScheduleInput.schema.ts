...
const Schema: z.ZodType<Prisma.ModuleItemUncheckedUpdateWithoutScheduleInput> =
  z
    .object({
      id: z
        .union([
...
export const ModuleItemUncheckedUpdateWithoutScheduleInputObjectSchema = Schema;
