...
const Schema: z.ZodType<Prisma.RolePermissionUncheckedUpdateManyWithoutPermissionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const RolePermissionUncheckedUpdateManyWithoutPermissionNestedInputObjectSchema =
  Schema;
