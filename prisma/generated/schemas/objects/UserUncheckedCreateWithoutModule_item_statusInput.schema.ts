...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutModule_item_statusInput> =
  z
    .object({
...
export const UserUncheckedCreateWithoutModule_item_statusInputObjectSchema =
  Schema;
