...
const Schema: z.ZodType<Prisma.ExamSheetSectionCreateNestedManyWithoutSectionInput> =
  z
    .object({
      create: z
        .union([
...
export const ExamSheetSectionCreateNestedManyWithoutSectionInputObjectSchema =
  Schema;
