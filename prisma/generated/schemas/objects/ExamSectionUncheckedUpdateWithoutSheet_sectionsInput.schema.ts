...
const Schema: z.ZodType<Prisma.ExamSectionUncheckedUpdateWithoutSheet_sectionsInput> =
  z
    .object({
      id: z
        .union([
...
export const ExamSectionUncheckedUpdateWithoutSheet_sectionsInputObjectSchema =
  Schema;
