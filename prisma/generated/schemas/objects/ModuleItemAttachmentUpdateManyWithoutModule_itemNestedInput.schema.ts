...
const Schema: z.ZodType<Prisma.ModuleItemAttachmentUpdateManyWithoutModule_itemNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleItemAttachmentUpdateManyWithoutModule_itemNestedInputObjectSchema =
  Schema;
