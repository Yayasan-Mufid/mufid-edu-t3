...
import { ModuleItemStatusUncheckedUpdateManyWithoutModule_itemNestedInputObjectSchema } from './ModuleItemStatusUncheckedUpdateManyWithoutModule_itemNestedInput.schema';
...
const Schema: z.ZodType<Prisma.ModuleItemUncheckedUpdateWithoutChildrenInput> =
  z
    .object({
      id: z
        .union([
      ...
      user_status: z
        .lazy(
          () =>
            ModuleItemStatusUncheckedUpdateManyWithoutModule_itemNestedInputObjectSchema,
        )
        .optional(),
      schedule: z
        .lazy(
...
export const ModuleItemUncheckedUpdateWithoutChildrenInputObjectSchema = Schema;
