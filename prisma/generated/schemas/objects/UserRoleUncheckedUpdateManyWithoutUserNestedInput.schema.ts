...
const Schema: z.ZodType<Prisma.UserRoleUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const UserRoleUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
