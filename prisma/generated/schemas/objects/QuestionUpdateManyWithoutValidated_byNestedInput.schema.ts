...
const Schema: z.ZodType<Prisma.QuestionUpdateManyWithoutValidated_byNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const QuestionUpdateManyWithoutValidated_byNestedInputObjectSchema =
  Schema;
