...
const Schema: z.ZodType<Prisma.ModuleItemQuestionUpdateManyWithoutModule_itemNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleItemQuestionUpdateManyWithoutModule_itemNestedInputObjectSchema =
  Schema;
