...
const Schema: z.ZodType<Prisma.StudyGroupStudentCreateNestedManyWithoutStudy_groupInput> =
  z
    .object({
      create: z
        .union([
...
export const StudyGroupStudentCreateNestedManyWithoutStudy_groupInputObjectSchema =
  Schema;
