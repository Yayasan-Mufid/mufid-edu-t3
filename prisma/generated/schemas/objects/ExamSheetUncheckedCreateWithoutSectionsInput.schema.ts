...
const Schema: z.ZodType<Prisma.ExamSheetUncheckedCreateWithoutSectionsInput> = z
  .object({
...
export const ExamSheetUncheckedCreateWithoutSectionsInputObjectSchema = Schema;
