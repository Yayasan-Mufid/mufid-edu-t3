...
const Schema: z.ZodType<Prisma.ExamSheetUncheckedCreateNestedManyWithoutGraderInput> =
  z
    .object({
      create: z
        .union([
...
export const ExamSheetUncheckedCreateNestedManyWithoutGraderInputObjectSchema =
  Schema;
