...
const Schema: z.ZodType<Prisma.ModuleUpdateManyWithoutProgramNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => ModuleUpdateManyWithWhereWithoutProgramInputObjectSchema),
        z
          .lazy(() => ModuleUpdateManyWithWhereWithoutProgramInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const ModuleUpdateManyWithoutProgramNestedInputObjectSchema = Schema;
