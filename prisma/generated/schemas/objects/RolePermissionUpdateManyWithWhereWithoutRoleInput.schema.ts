...
const Schema: z.ZodType<Prisma.RolePermissionUpdateManyWithWhereWithoutRoleInput> =
  z
    .object({
...
export const RolePermissionUpdateManyWithWhereWithoutRoleInputObjectSchema =
  Schema;
