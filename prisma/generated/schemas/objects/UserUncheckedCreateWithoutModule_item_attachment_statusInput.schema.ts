...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutModule_item_attachment_statusInput> =
  z
    .object({
...
export const UserUncheckedCreateWithoutModule_item_attachment_statusInputObjectSchema =
  Schema;
