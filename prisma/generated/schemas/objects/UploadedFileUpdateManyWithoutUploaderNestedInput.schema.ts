...
const Schema: z.ZodType<Prisma.UploadedFileUpdateManyWithoutUploaderNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const UploadedFileUpdateManyWithoutUploaderNestedInputObjectSchema =
  Schema;
