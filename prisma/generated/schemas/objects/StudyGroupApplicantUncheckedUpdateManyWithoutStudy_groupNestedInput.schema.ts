...
const Schema: z.ZodType<Prisma.StudyGroupApplicantUncheckedUpdateManyWithoutStudy_groupNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const StudyGroupApplicantUncheckedUpdateManyWithoutStudy_groupNestedInputObjectSchema =
  Schema;
