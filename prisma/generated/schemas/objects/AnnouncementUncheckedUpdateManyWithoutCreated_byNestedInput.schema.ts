...
const Schema: z.ZodType<Prisma.AnnouncementUncheckedUpdateManyWithoutCreated_byNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const AnnouncementUncheckedUpdateManyWithoutCreated_byNestedInputObjectSchema =
  Schema;
