...
const Schema: z.ZodType<Prisma.StudyGroupScheduleUpdateManyWithoutModule_itemNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const StudyGroupScheduleUpdateManyWithoutModule_itemNestedInputObjectSchema =
  Schema;
