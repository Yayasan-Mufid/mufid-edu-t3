...
const Schema: z.ZodType<Prisma.RolePermissionUncheckedCreateNestedManyWithoutPermissionInput> =
  z
    .object({
      create: z
        .union([
...
export const RolePermissionUncheckedCreateNestedManyWithoutPermissionInputObjectSchema =
  Schema;
