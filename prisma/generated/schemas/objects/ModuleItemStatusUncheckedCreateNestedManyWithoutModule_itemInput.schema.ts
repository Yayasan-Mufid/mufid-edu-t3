...
const Schema: z.ZodType<Prisma.ModuleItemStatusUncheckedCreateNestedManyWithoutModule_itemInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleItemStatusUncheckedCreateNestedManyWithoutModule_itemInputObjectSchema =
  Schema;
