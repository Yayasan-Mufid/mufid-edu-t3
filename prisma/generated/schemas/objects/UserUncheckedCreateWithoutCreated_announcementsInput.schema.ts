...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutCreated_announcementsInput> =
  z
    .object({
...
export const UserUncheckedCreateWithoutCreated_announcementsInputObjectSchema =
  Schema;
