...
const Schema: z.ZodType<Prisma.StudyGroupCreateNestedManyWithoutInvoice_accountInput> =
  z
    .object({
      create: z
        .union([
...
export const StudyGroupCreateNestedManyWithoutInvoice_accountInputObjectSchema =
  Schema;
