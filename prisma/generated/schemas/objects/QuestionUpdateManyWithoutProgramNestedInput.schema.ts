...
const Schema: z.ZodType<Prisma.QuestionUpdateManyWithoutProgramNestedInput> = z
  .object({
    create: z
      .union([
...
export const QuestionUpdateManyWithoutProgramNestedInputObjectSchema = Schema;
