...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutManaged_groupsInput> =
  z
    .object({
...
export const UserUncheckedCreateWithoutManaged_groupsInputObjectSchema = Schema;
