...
const Schema: z.ZodType<Prisma.ExamSheetUncheckedUpdateManyWithoutGraderNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ExamSheetUncheckedUpdateManyWithoutGraderNestedInputObjectSchema =
  Schema;
