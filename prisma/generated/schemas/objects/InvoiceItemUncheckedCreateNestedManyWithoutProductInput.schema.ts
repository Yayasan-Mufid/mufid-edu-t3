...
const Schema: z.ZodType<Prisma.InvoiceItemUncheckedCreateNestedManyWithoutProductInput> =
  z
    .object({
      create: z
        .union([
...
export const InvoiceItemUncheckedCreateNestedManyWithoutProductInputObjectSchema =
  Schema;
