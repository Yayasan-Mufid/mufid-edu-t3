...
const Schema: z.ZodType<Prisma.QuestionUncheckedCreateNestedManyWithoutProgramInput> =
  z
    .object({
      create: z
        .union([
...
export const QuestionUncheckedCreateNestedManyWithoutProgramInputObjectSchema =
  Schema;
