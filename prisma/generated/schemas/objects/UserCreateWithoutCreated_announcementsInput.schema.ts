...
const Schema: z.ZodType<Prisma.UserCreateWithoutCreated_announcementsInput> = z
  .object({
...
export const UserCreateWithoutCreated_announcementsInputObjectSchema = Schema;
