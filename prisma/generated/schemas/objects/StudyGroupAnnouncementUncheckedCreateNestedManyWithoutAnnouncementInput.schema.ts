...
const Schema: z.ZodType<Prisma.StudyGroupAnnouncementUncheckedCreateNestedManyWithoutAnnouncementInput> =
  z
    .object({
      create: z
        .union([
...
export const StudyGroupAnnouncementUncheckedCreateNestedManyWithoutAnnouncementInputObjectSchema =
  Schema;
