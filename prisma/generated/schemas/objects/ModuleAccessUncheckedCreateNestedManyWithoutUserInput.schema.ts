...
const Schema: z.ZodType<Prisma.ModuleAccessUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleAccessUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
