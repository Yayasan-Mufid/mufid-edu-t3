...
import { QuestionUpdateManyWithoutModuleNestedInputObjectSchema } from './QuestionUpdateManyWithoutModuleNestedInput.schema';
import { ExamUpdateManyWithoutModuleNestedInputObjectSchema } from './ExamUpdateManyWithoutModuleNestedInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.ModuleUpdateWithoutStudy_groupsInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    students: z
      ...
      .optional(),
    questions: z
      .lazy(() => QuestionUpdateManyWithoutModuleNestedInputObjectSchema)
      .optional(),
    exams: z
...
export const ModuleUpdateWithoutStudy_groupsInputObjectSchema = Schema;
