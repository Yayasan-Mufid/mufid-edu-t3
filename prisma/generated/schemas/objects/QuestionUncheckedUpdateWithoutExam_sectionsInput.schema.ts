...
const Schema: z.ZodType<Prisma.QuestionUncheckedUpdateWithoutExam_sectionsInput> =
  z
    .object({
      id: z
        .union([
...
export const QuestionUncheckedUpdateWithoutExam_sectionsInputObjectSchema =
  Schema;
