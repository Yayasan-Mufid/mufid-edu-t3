...
const Schema: z.ZodType<Prisma.ExamSheetSectionUncheckedUpdateManyWithoutSectionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ExamSheetSectionUncheckedUpdateManyWithoutSectionNestedInputObjectSchema =
  Schema;
