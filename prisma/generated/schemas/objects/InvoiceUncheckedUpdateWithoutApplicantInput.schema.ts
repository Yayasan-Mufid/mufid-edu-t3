...
const Schema: z.ZodType<Prisma.InvoiceUncheckedUpdateWithoutApplicantInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const InvoiceUncheckedUpdateWithoutApplicantInputObjectSchema = Schema;
