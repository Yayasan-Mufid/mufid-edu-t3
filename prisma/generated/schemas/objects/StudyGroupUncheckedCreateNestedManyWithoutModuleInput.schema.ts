...
const Schema: z.ZodType<Prisma.StudyGroupUncheckedCreateNestedManyWithoutModuleInput> =
  z
    .object({
      create: z
        .union([
...
export const StudyGroupUncheckedCreateNestedManyWithoutModuleInputObjectSchema =
  Schema;
