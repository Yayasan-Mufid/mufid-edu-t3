...
const Schema: z.ZodType<Prisma.ExamSectionQuestionUncheckedCreateNestedManyWithoutSectionInput> =
  z
    .object({
      create: z
        .union([
...
export const ExamSectionQuestionUncheckedCreateNestedManyWithoutSectionInputObjectSchema =
  Schema;
