...
const Schema: z.ZodType<Prisma.ModuleItemQuestionStatusUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleItemQuestionStatusUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
