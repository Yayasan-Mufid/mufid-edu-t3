...
const Schema: z.ZodType<Prisma.ProgramAdminUncheckedCreateNestedManyWithoutProgramInput> =
  z
    .object({
      create: z
        .union([
...
export const ProgramAdminUncheckedCreateNestedManyWithoutProgramInputObjectSchema =
  Schema;
