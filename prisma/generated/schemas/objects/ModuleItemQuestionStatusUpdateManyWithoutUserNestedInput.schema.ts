...
const Schema: z.ZodType<Prisma.ModuleItemQuestionStatusUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ModuleItemQuestionStatusUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
