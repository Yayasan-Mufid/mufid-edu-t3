...
const Schema: z.ZodType<Prisma.UploadedFileCreateNestedManyWithoutUploaderInput> =
  z
    .object({
      create: z
        .union([
...
export const UploadedFileCreateNestedManyWithoutUploaderInputObjectSchema =
  Schema;
