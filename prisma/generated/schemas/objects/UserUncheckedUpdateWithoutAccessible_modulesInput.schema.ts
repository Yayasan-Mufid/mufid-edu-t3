...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutAccessible_modulesInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutAccessible_modulesInputObjectSchema =
  Schema;
