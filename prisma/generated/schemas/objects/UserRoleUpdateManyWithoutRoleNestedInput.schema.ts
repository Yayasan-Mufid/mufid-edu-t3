...
const Schema: z.ZodType<Prisma.UserRoleUpdateManyWithoutRoleNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => UserRoleUpsertWithWhereUniqueWithoutRoleInputObjectSchema),
        z
          .lazy(() => UserRoleUpsertWithWhereUniqueWithoutRoleInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => UserRoleUpdateWithWhereUniqueWithoutRoleInputObjectSchema),
        z
          .lazy(() => UserRoleUpdateWithWhereUniqueWithoutRoleInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const UserRoleUpdateManyWithoutRoleNestedInputObjectSchema = Schema;
