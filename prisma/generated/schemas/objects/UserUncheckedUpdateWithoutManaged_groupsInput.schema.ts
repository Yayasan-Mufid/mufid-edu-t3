...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutManaged_groupsInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateWithoutManaged_groupsInputObjectSchema = Schema;
