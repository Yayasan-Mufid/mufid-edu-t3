...
import { StudyGroupAnnouncementCreateNestedManyWithoutStudy_groupInputObjectSchema } from './StudyGroupAnnouncementCreateNestedManyWithoutStudy_groupInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.StudyGroupCreateWithoutInvoice_accountInput> = z
  .object({
    ...
    announcements: z
      .lazy(
        () =>
          StudyGroupAnnouncementCreateNestedManyWithoutStudy_groupInputObjectSchema,
      )
      .optional(),
  })
  .strict();

export const StudyGroupCreateWithoutInvoice_accountInputObjectSchema = Schema;
