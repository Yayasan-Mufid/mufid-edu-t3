...
const Schema: z.ZodType<Prisma.QuestionUncheckedUpdateWithoutModule_item_questionInput> =
  z
    .object({
      id: z
        .union([
...
export const QuestionUncheckedUpdateWithoutModule_item_questionInputObjectSchema =
  Schema;
